 ...
 * @subpackage streams
 */
class XmlStreamReader extends BasicInputStreamReader {	
	/**
	 * 
	 * @param mixed $file A path to a file, an IFile object or a FileInputStream object
	 * @param array $params
	 */
	public function __construct(IInputStream $in, array $params = null) {
		parent::__construct($in, $params);
	}
