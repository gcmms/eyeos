 ...
 * @subpackage streams
 */
class XmlStreamWriter extends BasicOutputStreamWriter {	
	...
	public function __construct(IOutputStream $out, array $params = null) {
		parent::__construct($out, $params);
		$this->formatOutput = isset($params[self::PARAM_FORMATOUTPUT]) ? $params[self::PARAM_FORMATOUTPUT] : true;
	}
