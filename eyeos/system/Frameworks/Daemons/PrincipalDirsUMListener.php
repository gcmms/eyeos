 ...
 * @subpackage Daemons
 */
class PrincipalDirsUMListener extends AbstractUMAdapter {
	private static $Instance = null;

	public static function getInstance() {
		if (self::$Instance === null) {
			self::$Instance = new PrincipalDirsUMListener();
		}
	...
	public function workgroupCreated(UMEvent $e) {
		if ($e->getSource() instanceof AbstractEyeosWorkgroup) {
			...
			AdvancedPathLib::cpdirs(SYSTEM_SKEL_PATH . '/' . WORKGROUPS_DIR, $workgroupDirPath, false);
		}
	}
...
UMManager::getInstance()->addUMListener(PrincipalDirsUMListener::getInstance());
?>
